                ...
                <div class="flex-row t-p">
                    <div class="box info account-adjust-box">
                        <div class="edit-user-info">
                            <form action="#" method="post" novalidate="novalidate" class="validated-form">
                                <div class="row">
                                   
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group"><label for="first-name">جنسیت</label> <select
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group"><label for="last-name">نام و نام خانوادگی</label> <input
                                                type="text" id="last-name" name="last-name" class="form-control">
                                            <!---->
                                        </div>
                                    </div>
                                    
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group"><label for="phone">تلفن همراه</label> <input type="text"
                                                id="phone" name="phone" class="form-control text-left ltr">
                                            <!---->
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group"><label for="telephoneNumber">شماره تلفن</label> <input
                                                type="text" maxlength="12" id="telephoneNumber" name="telephone"
                                                placeholder="021-88888888" class="form-control ltr"
                                                data-mask="###-########" data-previous-value="">
                                            <!---->
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group"><label for="national-id">کد ملی</label> <input
                                                type="text" id="national-id" name="national-id"
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group"><label for="cardNumber">شماره کارت</label> <input
                                                type="text" maxlength="19" id="cardNumber" name="cardNumber"
                                                class="form-control ltr" data-mask="####-####-####-####"
                                                data-previous-value="">
                                            <!---->
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group"><label for="accountNumber">شماره حساب</label> <input
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group sheba-no"><label for="shebaNumber">شماره شبا</label>
                                            <input type="text" maxlength="30" id="shebaNumber" name="shebaNumber"
                                                class="form-control ltr" data-mask="##-####-####-####-####-####-##"
                                                data-previous-value="">
                                            <!----> <label for="shebaNumber" class="inside-label w-500">IR</label></div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-xs-6"><button type="submit" class="btn btn-block btn-primary"><span>
                                                ویرایش اطلاعات
                                            </span> <span style="display: none;">
                                                تکمیل اطلاعات
                                            </span> <span class="dots" style="display: none;">...</span></button></div>
                                </div>
                                <div class="box-alert-account row">
                                    <!---->
                                    <!---->
                                </div>
                            </form>
